...
app = Flask(__name__)
app.config['MONGO_URI']='mongodb://mongochapolin:anNKMHjNpT8f0uKCxt13UUlH4kMVYJyQZAFtSnvpwX0ld1sUo8sXPPBx4ZIQVKnZZ2fImC6C7R5Hb4O0l1okDw==@mongochapolin.mongo.cosmos.azure.com:10255/ViladoChaves?ssl=true&retrywrites=false' 
mongo = PyMongo(app)
